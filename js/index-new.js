...
function initVisualFilter() {
  ...
  $(document).ready(function(){
    ...
    $('.development-btn').click(function(){
     ...
     $('.softwareEngineering-btn').click(function(){
      if ($(this).hasClass('active')) {
      } else {
          $('.toggle-row .btn-normal').removeClass('active');
          $('.toggle-row .btn-normal').addClass('not-active');
          ...
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.softwareEngineering, .mouse-pos-list-image-wrap li.softwareEngineering, .work-tiles li.softwareEngineering').addClass('visible');
          }, 300);
      }
    });
     $('.graphicDesign-btn').click(function(){
      if ($(this).hasClass('active')) {
      } else {
          $('.toggle-row .btn-normal').removeClass('active');
          $('.toggle-row .btn-normal').addClass('not-active');
          ...
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.graphicDesign, .mouse-pos-list-image-wrap li.graphicDesign, .work-tiles li.graphicDesign').addClass('visible');
          }, 300);
      }
    });
     $('.copywriting-btn').click(function(){
      if ($(this).hasClass('active')) {
      } else {
          $('.toggle-row .btn-normal').removeClass('active');
          $('.toggle-row .btn-normal').addClass('not-active');
          ...
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.copywriting, .mouse-pos-list-image-wrap li.copywriting, .work-tiles li.copywriting').addClass('visible');
          }, 300);
      }
    });
    $('.awards-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.awards, .mouse-pos-list-image-wrap li.awards, .work-tiles li.awards').addClass('visible');
          }, 300);
      }
    });
    $('.experience-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.experience, .mouse-pos-list-image-wrap li.experience, .work-tiles li.experience').addClass('visible');
          }, 300);
      }
    });
